...
vectorizer = TfidfVectorizer(max_features=500, norm='l2', sublinear_tf=True)
...
#file_dict['feature_names'] = vectorizer.get_feature_names()
scipy.io.savemat('spam_data.mat', file_dict)

feat_dict={}
feat_dict['feature_names'] = vectorizer.get_feature_names()
scipy.io.savemat('feature_names', feat_dict)
